class Config:
    def __init__(
        ...
        #### MODIF HERE ####
        if self.corpus_name == "flue":
            self.train_freq_buckets = [(1, 2), (2, 24)] #[(5, 15), (15, 25)] 
            self.prevalence_buckets = [(0.0, 1.0)]  # One only range, includes everything -> as if ignoring rarity metric
        #### MODIF HERE #### 
        else:
